...
//        var B = Math.max( Math.cos( S * Math.PI ), 0.0 );
        var R = 1;
        var G = 1.0 - Math.cos( ( S - 1.0 ) * Math.PI * 0.5 );
        var B = 1.0 - Math.cos( ( S - 1.0 ) * Math.PI * 0.5 );
...
//white ~ red
    ...
    for ( var i = 0; i < nfaces; i++ )
    {
        ...
        var S0 = parseInt((scalars[ id[0] ] - 0.1) * norm);
        var S1 = parseInt((scalars[ id[1] ] - 0.1) * norm);
        var S2 = parseInt((scalars[ id[2] ] - 0.1) * norm);
        //var S3 = parseInt((scalars[ id[3] ] - 0.1) * norm);
