...
//x座標y座標z座標が1次元になっているので、resolutionを用いてy座標などを表す
...
//補完する関数
    ...
    {
          var v0_id = v0.x + (v0.y * volume.resolution.x) + (v0.z * (volume.resolution.x * volume.resolution.y));
          var v1_id = v1.x + (v1.y * volume.resolution.x) + (v1.z * (volume.resolution.x * volume.resolution.y));
          var s0 = volume.values[v0_id][0];
          var s1 = volume.values[v1_id][0];
          var t = (s-s0)/(s1-s0);
